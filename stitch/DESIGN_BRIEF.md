...
- PulsePuck Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called PulsePuck Lite. It should be a reflex arcade game where the player controls a paddle to deflect a glowing puck, break moving targets, pause/resume, open settings/help, adjust difficulty/audio, persist high score, and expose testable runtime state. Use full-viewport gamepla…
...
- Gameplay - PulsePuck Lite
- Game Settings - PulsePuck Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - PulsePuck Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - PulsePuck Lite
